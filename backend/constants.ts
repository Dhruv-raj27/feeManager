...
export const PAYMENT_MODES_WITH_REFERENCE: readonly PaymentMode[] = [
  "UPI",
  "RTGS",
  "NEFT",
];

export const PAYMENT_MODES_WITH_INSTRUMENT: readonly PaymentMode[] = [
  "Cheque",
  "DD",
];

export const PAYMENT_MODES_WITH_BANK: readonly PaymentMode[] = [
  "RTGS",
  "NEFT",
  "Cheque",
  "DD",
